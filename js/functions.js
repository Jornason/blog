...
window.customLocation = function () {
...
window.updateWeatherPart = function (data) {
  var dt = data.dt * 1000;
...
window.randomTags = function (flag) {
...
window.getPageViewCount = function (dataurl) {
  if (!dataurl) {
...
window.parsePageViewData = function (rows) {
  if (!rows) {
    return;
  }
...
window.showMyWishBooks = function () {
...
window.parseBookDatas = function (data) {
...
window.showSearchResult = function (data) {
...
window.getGALogFile = function (dataurl) {
  if (!dataurl) {
...
window.parseGALog = function (data) {
  var overalldata = {};
...
window.showLogData = function (rq, ptotal, utotal, id) {
...
window.showAlert = function (status, msg, duration) {
