...
$(function () {
  ...
  var startTimeliner = function (options) {
    var settings = {
    ...
    var openStartEvents = function (events) {
    ...
    var openEvent = function (eventHeading, eventBody) {
      ...
      $(eventHeading).find("a").removeClass("closed").addClass("open").addClass(color).prev("div.arrow").addClass(color).show().end().animate({
    ...
    var closeEvent = function (eventHeading, eventBody) {
      $(eventHeading).find("a").animate({
        fontSize: settings.fontClosed
      }, 0).removeClass("open orange green purple").prev("div.arrow").removeClass("orange green purple").hide().end().addClass("closed");
